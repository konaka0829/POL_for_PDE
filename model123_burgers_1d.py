...
def compute_and_save_defect_outputs(args, s, x_test_all, y_test_all, per_sample_abs, per_sample_rel):
    ...
    metrics = {
        **result["summary"],
        ...
        "model": args.model,
        "target_trajectory_solver": args.burgers_scheme,
        "surrogate_trajectory_solver": args.burgers_scheme if args.reservoir == "burgers" else args.reservoir,
        "burgers_scheme": args.burgers_scheme,
        "burgers_dealias": bool(args.burgers_dealias),
        "domain_length": domain_length,
        "effective_nx": effective_nx,
        ...
        "dt": float(args.dt),
        "T": float(args.T),
        "Ttilde": float(args.Ttilde),
        "alpha": float(args.Ttilde / args.T),
        "defect_time_quadrature": args.defect_time_quadrature,
    ...
    with open(os.path.join(args.out_dir, "run_config.json"), "w", encoding="utf-8") as f:
        ...
        run_payload = {
            ...
            **get_runtime_info(),
            ...
            "defect_diagnostics": (
                {
                    "target_trajectory_solver": defect_metrics.get("target_trajectory_solver"),
                    "surrogate_trajectory_solver": defect_metrics.get("surrogate_trajectory_solver"),
                    "burgers_scheme": defect_metrics.get("burgers_scheme"),
                    "burgers_dealias": defect_metrics.get("burgers_dealias"),
                    "domain_length": defect_metrics.get("domain_length"),
                    "effective_nx": defect_metrics.get("effective_nx"),
                    "dx": defect_metrics.get("dx"),
                    "dt": defect_metrics.get("dt"),
                    "T": defect_metrics.get("T"),
                    "Ttilde": defect_metrics.get("Ttilde"),
                    "alpha": defect_metrics.get("alpha"),
                    "defect_time_quadrature": defect_metrics.get("defect_time_quadrature"),
                    "l2h_convention": defect_metrics.get("l2h_convention"),
                }
